...
const NavBar = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-4 fixed top-0 left-0 right-0 z-50 shadow-lg">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-4 px-4">
